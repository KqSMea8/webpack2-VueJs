...
$news101 = array('pubtime' => $pubtime[0] , 'title' => $title[0],'desc' => $desc[0]);
$news102 = array('pubtime' => $pubtime[1] , 'title' => $title[1],'desc' => $desc[1]);
$news103= array('pubtime' => $pubtime[2] , 'title' => $title[2],'desc' => $desc[2]);
$news104 = array('pubtime' => $pubtime[3] , 'title' => $title[3],'desc' => $desc[3]);
