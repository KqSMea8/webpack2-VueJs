		...
		<div class="panel cancel-margin-right">
			...
			<div class="footer-ul">
				<ul class="pagination">
					...
					<!--defaults是当前页码鼠标样式 hovers是其它页码鼠标样式 actives是当前页码颜色-->
	...
	methods: {
		...
		paginateChecked(checkedPage) {
			...
			if(checkedPage >= 4 && checkedPage <= this.maxPage - 2) {
				...
				// 将删除 index 2 ("3") 页码，并添加当前页码来替代被删除的页码：
