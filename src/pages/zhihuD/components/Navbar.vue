			...
			<nav class = "nav purple lighten-2">
				<div class = "nav-wrapper">
					...
					<ul id = "nav-mobile" class = "right">
						<li>
							<a class = "dropdown-button" data-activates = "subjects">主题日报</a>
						</li>
						<li>
							<a class = "dropdown-button" data-activates = "others">
					...
					<ul id = "others" class = "dropdown-content">
						<li class = "waves-effect waves-light">
							<router-link class = "app-route-link" to = "/favorites">我的收藏</router-link>
						</li>
						<li class = "waves-effect waves-light">
