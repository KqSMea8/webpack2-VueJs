		...
		<ol class = "com-list animation-style-4" v-if = "!state.loading">
			<li class = "com-list__track" v-for = "(comment,index) in comments">
				...
				<div class = "com-list__track__info">
					<p class = "com-list__track__info__title">
						<span>{{comment.nickname}}:</span>&nbsp; {{comment.content}}
					</p>
					<span class = "com-list__track__info__sub-title"> {{comment.time | getTime}} </span>
				</div>
				<span class = "com-list__track__liked-count"> {{comment.likedCount}}人赞同 </span>
			</li>
		</ol>
