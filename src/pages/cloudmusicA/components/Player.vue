		...
		<div class = "player">
			<div class = "player--topbox" :class = "{'shake-slow shake-constant':shaking}">
				...
				<div class = "player__cover--wrapper">
					<!--fork me on github-->
					<a href = "https://github.com/Alex-xd/seeMusic">
						<img style = "z-index:200000;width: 30%;height:25%;position: absolute; top: 0; left: 0; border: 0;" src = "../assets/forkMe.png" alt = "Fork me on GitHub" data-canonical-src = "https://s3.amazonaws.com/github/ribbons/forkme_left_red_aa0000.png">
					</a>
