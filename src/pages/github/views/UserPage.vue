<template lang="html">
    <div id="user-page" class="animated" style="animation-duration: .5s;">
        <profile :username="profile.login" :profile="profile"></profile>
        <div class="repo-list">
            ...
            <list-transition>
                <repo-item
                    ...
                    :data-index="index"></repo-item>
            </list-transition>
        </div>
        <router-link class="view-all-btn" :to="{name: 'USER_REPO_LIST'}"> VIEW ALL REPOS </router-link>
    </div>
</template>
