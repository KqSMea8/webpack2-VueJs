		...
		<div class = "com-article">
				...
				<div class = "name">
					<p>{{resData.memberNickname}}
						<span v-bind:class = "{ hasZan : !(resData.memberIsFavShared-1) }" class = "Userstar"
						      @click = "userstar(resData.memberId)">
			...
			<p class = "operate">
				<span class = "zan" v-bind:class = "{ hasZan : !(resData.memberIsThumbs-1) }"
				      @click = "zan(resData.sharedId)">
					<span class = "icon iconfont icon-zans"></span><span>{{thumbNum}}</span>
				</span>
				...
				<span v-bind:class = "{ hasZan : !(resData.memberIsFavShared-1) }" class = "star"
				      @click = "star(resData.sharedId,resData.memberId)">
					<span class = "icon iconfont icon-jushoucang"></span>
					<span> 收藏</span>
				</span>
			</p>
