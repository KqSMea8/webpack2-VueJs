			...
			<div class = "col-md-9">
				<div class = "topic-detail panel panel-default">
					<div class = "panel-heading">
						<div class = "topic-infos">
							...
							<div class = 'topic-info'>
								...
								<span> · 最后由
									<router-link :to = "'/users/' + topic.last_reply_user_id">{{topic.last_reply_user_login}}</router-link>
								       回复于 {{ formatTime().replyTime }} </span>
					...
					<div class = "panel-body markdown">
						<article v-html = "topic.body_html"></article>
					</div>
					<!--赞数-->
					<div class = "panel-footer">
						<div class = "opts">
							<a class = "likeable  tooltipstered" href = "#">
								<i class = "fa fa-heart"></i>
								<span>{{topic.likes_count}} 个赞</span>
							</a>
						</div>
					</div>
				</div>
